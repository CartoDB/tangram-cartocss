...
describe('CCSS', () => {
	...
	let conf = CCSS.carto2Draw(CartoCSS);
	...
	describe('.carto2Draw', () => {
	    ...
	    describe('.draw', () => {
			...
			it('should have a polygons_blend property', () => {
				assert.property(conf.draw, 'polygons_blend');
			});


			describe('.polygons_blend', () => {
				let pb = conf.draw.polygons_blend;
			...
			it('should have a lines_blend property', () => {
				assert.property(conf.draw, 'lines_blend');
			});
			...
			it('should have a points_blend property', () => {
				assert.property(conf.draw, 'points_blend');
			});
	...
	describe('.color porperty', () => {
		let color = conf.draw.polygons_blend.color;
